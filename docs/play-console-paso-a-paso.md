...
Prueba del binario de Play (2026-09-26, Redmi Note 13 Pro+, Android 16): instalada la versión 4 desde Play Store tras desinstalar el APK de preview (versionCode 2, otra firma). Solo declara el permiso de cámara, expo-updates consulta el canal sin error, y login, Noticias, cámara, código manual `0001` y Perfil funcionan sin errores en logcat. Único fallo: el bloque de código manual de la pantalla de escaneo quedaba bajo la barra de navegación de Android (sin insets de zona segura); corregido y publicado como EAS Update en el canal `production` el 2026-09-26 (grupo `4669764f`); el móvil lo descargó en el primer arranque y lo aplicó en el segundo.
